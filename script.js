...
// === Player state ===
let posX = 0;
let posY = groundY + 0 * BLOCK_SIZE + 280; // Start on top layer with offset for character height
let posZ = 0;
let yaw = 0, pitch = 0;
...
const speed = 2;
const gravity = 1.5;
const jumpStrength = -70; // negative because your y axis is inverted (smaller y is higher)
let velY = 0;
let grounded = false;
